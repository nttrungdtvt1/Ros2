...
class MissionManagerNode(Node):
    ...
    def _on_amcl(self, msg: PoseWithCovarianceStamped) -> None:
        ...
        # ĐÃ SỬA: Nới lỏng ngưỡng an toàn từ 0.05 lên 0.25 để phù hợp với môi trường thực tế
        if cov_yaw > 0.25:
            self.get_logger().warning(f'AMCL yaw uncertainty very high ({cov_yaw:.3f}), waiting for convergence...', throttle_duration_sec=3.0)
            return
